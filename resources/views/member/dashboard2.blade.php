                            ...
                            function openPepeRedeemPrompt() {
                                ...
                                Swal.fire({
                                    ...
                                    html: `
                                        ...
                                        `)</small>
                                            ...
                                            <div class="p-2 rounded bg-dark border border-secondary text-start" style="font-size: 12px;">
                                                <span class="text-info"><i class="fas fa-network-wired me-1"></i> <strong>Network:</strong> ` + (settings.network_name ||
                                    ...
                                    preConfirm: () => {
                                        ...
                                        var targetWallet = $('#swal_pepe_wallet').val().trim();

                                        if (!targetWallet || targetWallet.length < 10) {
                                            Swal.showValidationMessage('Valid linked BEP-20 wallet address is required.');
                                            return false;
                                        }
                                        if (!amount || amount <= 0) {
                                        ...
                                        if (amount > availableBalance) {
                                            Swal.showValidationMessage('Amount cannot exceed available tokens of ' +
                                                availableBalance + ' ' + (settings.token_symbol || 'PEPE') + '.');
                                            return false;
                                        }
                                        if (amount < minRedeem) {
                                    ...
                                    if (isContractClaim) {
                                        ...
                                        Swal.fire({
                                            ...
                                            html: `
                                                ...
                                                `</strong><br>
                                                        <span class="text-white-50">Recipient:</span> <code class="text-white small">` + activeWallet.substring(0, 8) + '...' + activeWallet
                                        ...
                                        Swal.fire({
                                            ...
                                            html: `
                                                ...
                                                Number(v.amount).toLocaleString() + ` ` + (v.token_symbol || 'PEPE') +
                                                `</strong><br>
                                                        <span class="text-white-50">Recipient Wallet:</span> <code class="text-white small">` + activeWallet.substring(0, 8) + '...' +
