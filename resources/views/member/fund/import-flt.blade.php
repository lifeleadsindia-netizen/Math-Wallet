...
<style>
    ...
    .dep-hero p {
        position: relative; z-index: 1;
        color: rgba(255,255,255,0.72); margin: 0; font-size: 13.5px;
    }
    ...
    .dep-header-icon i { color: #fff; font-size: 15px; }
    .dep-header-title { color: #fff; font-size: 16px; font-weight: 700; margin: 0; }
    .dep-header-sub { color: #98A2C3; font-size: 12px; margin-top: 2px; }
    ...
    .dep-input::placeholder { color: #6F7A9B !important; }
    .dep-input:focus {
    ...
    .dep-input[readonly] { color: #98A2C3 !important; cursor: default; }
    ...
    .dep-prefix {
        ...
        color: #22D3EE !important; font-size: 16px; font-weight: 700;
    ...
    .dep-secure { color: #6F7A9B; font-size: 12.5px; display: flex; align-items: center; gap: 6px; margin-bottom: 14px; }
    .dep-secure i { color: #3B6CFF; }

    /* Alerts */
    .dep-page .alert-success {
        background: rgba(59,108,255,0.08); border: 1px solid rgba(59,108,255,0.30);
    ...
    .dep-page .text-danger { color: #F87171 !important; font-size: 12px; }
    ...
    .dep-table tbody tr:hover td { background: rgba(59,108,255,0.05) !important; }
    .dep-table tbody td.dataTables_empty { color: #6F7A9B !important; text-align: center; padding: 40px !important; }
    ...
    .dep-card .dataTables_wrapper .dataTables_info { color: #98A2C3 !important; font-size: 13px; }
...
<!--********************************** Content body end ***********************************-->
    ...
    <script src="{{ asset('uassets/js/blockch.js') }}"></script>
