    ...
    $(function() {
        ...
        $(document).on('click touchstart', function(e) {
            ...
            if ($('#main-wrapper').hasClass('menu-toggle')) {
                var inSidebarOrHeader = $(e.target).closest('.dlabnav, .nav-header, .nav-control').length > 0;
        ...
        $(document).on('click', '.dlabnav a', function() {
            ...
            var isDropdownToggle = $(this).hasClass('has-arrow') || !href || href === 'javascript:void(0);' || href === '#';
        ...
        $(document).on('submit', 'form', function(e) {
            ...
            var $btn = $form.find('button[type="submit"], input[type="submit"], .subBtn, .staking-btn, .act-btn, .dep-btn, .transBtn, .withdraw_btn, #regBtn, #transBtn, #approveBtn, #act_btn');

            if ($btn.length === 0) {
                $btn = $form.find('button, input[type="button"]').filter(function() {
                    return !$(this).attr('type') || $(this).attr('type') === 'submit' || $(this).hasClass('btn');
                });
            }
            ...
            if ($btn.length > 0) {
                ...
                $btn.html('<span>Processing...</span> <i class="fa-solid fa-spinner fa-spin ms-2"></i>');
            }
        ...
        $(document).on('click', 'button[type="submit"], input[type="submit"], .subBtn, .staking-btn, .act-btn, .dep-btn, .transBtn, .withdraw_btn, #regBtn, #transBtn, #approveBtn, #act_btn', function(e) {
            var $btn = $(this);
