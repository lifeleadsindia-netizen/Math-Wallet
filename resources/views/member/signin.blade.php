...
<!-- Mirrored from jiade.vercel.app/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 07:33:01 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta property="og:image" content="../jiade.dexignlab.com/xhtml/social-image.png">
    ...
    <meta name="twitter:image" content="../jiade.dexignlab.com/xhtml/social-image.png">
    ...
    <div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
        <div class="login-aside text-center  d-flex flex-column flex-row-auto">
            ...
            <div class="aside-image position-relative" style="background-image:url(images/background/pic-2.png);">
                <img class="img1 move-1" src="{{ asset('uassets/images/background/pic3.png') }}" alt="">
                <img class="img2 move-2" src="{{ asset('uassets/images/background/pic4.png') }}" alt="">
                <img class="img3 move-3" src="{{ asset('uassets/images/background/pic5.png') }}" alt="">
                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12 tab-content">
                            <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                                <form action="https://jiade.vercel.app/index.html">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-xl-6 col-12">
                                            <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm btn-block">
                                                <svg class="me-1" width="16" height="16" viewBox="0 0 28 28"
                                ...
                                <div class="new-account mt-3 text-center">
                                    <p class="font-w500">Already have an account? <a class="text-primary"
                                            href="page-login.html" data-toggle="tab">Sign in</a></p>
                                </div>
                            </div>
...
<!-- Mirrored from jiade.vercel.app/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Feb 2026 07:33:04 GMT -->
