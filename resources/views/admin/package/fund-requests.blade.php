        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ __('Fund Requests')}}</h5>
                        <span>{{ __('All Fund Requests ')}}</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Fund Requests')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $list )
                                <tr>
                                    ...
                                    <td><a href="{{url('ncaweuifuiscjdiewq/accept-fundrequest')}}/{{$list['id']}}" class="btn btn-sm btn-primary">Accept</a></td>
                                </tr>
