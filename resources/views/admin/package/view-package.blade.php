        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ __('View Package')}}</h5>
                        <span>{{ __('View Package ')}}</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $list )
                                <tr>
                                    ...
                                    <td><a href="{{url('ncaweuifuiscjdiewq/view-package')}}/{{$list['id']}}" class="btn btn-sm btn-primary">View Details</a></td>
                                    {{-- <td><a href="{{url('ncaweuifuiscjdiewq/activate-package')}}/{{$list['id']}}/{{$list['package_value']}}" class="btn btn-sm btn-primary">Activate</a></td> --}}
                                </tr>
                                @php $i++;  @endphp
                            @endforeach
                        </tbody>
